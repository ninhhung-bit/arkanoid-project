Danh sách nhóm:
- Nguyễn Thế An (Nhóm trưởng) (30%): powerup (slowball, slowpaddle, fastball, shrinkpaddle, death, speedup paddle, expandpaddle), scoreboard, logic game, button in main menu (), brick, strongbrick, UML(2)

- Nguyễn Đức Mạnh (27%): power up (multiball, piercing, expandpaddle, reversecontrol,speedup paddle  ), logic game, brick, button pause and resume, movable object, UML(1)

- Ninh Ngọc Hưng (23%): main menu, sound, option menu, button in main menu (), logic game speed ball, game setting
...
- DeathPowerUp ![DeathPowerUp](src/images/DeathPowerUp.png): Tắt toàn bộ chương trình
